...
class DependenciesTest extends TestCase
{
    public function testInvokation()
    {
        ...
        $this->assertCount(34, $packages);
        $expected = <<<DOT
digraph packages {
    subgraph cluster_innmind {
        label="innmind"
        URL="https://packagist.org/packages/innmind/"
    innmind__cli [label="cli@1.7.1"];
    innmind__stream [label="stream@1.5.0"];
    innmind__immutable [label="immutable@2.16.0"];
    innmind__time_continuum [label="time-continuum@1.3.0"];
    innmind__url [label="url@2.0.3"];
    innmind__operating_system [label="operating-system@1.6.0"];
    innmind__server_status [label="server-status@1.3.0"];
    innmind__server_control [label="server-control@2.8.3"];
    innmind__filesystem [label="filesystem@3.3.1"];
    innmind__socket [label="socket@2.1.0"];
    innmind__event_bus [label="event-bus@3.0.0"];
    innmind__ip [label="ip@1.0.0"];
    innmind__http_transport [label="http-transport@4.1.0"];
    innmind__http [label="http@3.11.1"];
    innmind__time_warp [label="time-warp@1.0.0"];
    innmind__signals [label="signals@1.0.0"];
    ...
    league__uri [label="uri@6.0.0"];
    league__uri_interfaces [label="uri-interfaces@2.0.0"];
    }
    ...
    symfony__process [label="process@v4.3.5"];
    symfony__filesystem [label="filesystem@v4.3.5"];
    symfony__polyfill_ctype [label="polyfill-ctype@v1.12.0"];
    symfony__finder [label="finder@v4.3.5"];
    symfony__dotenv [label="dotenv@v4.3.5"];
    }
    ...
    innmind__stream -> innmind__immutable [color="#5eb3ec", label="^2.13"];
    ...
    innmind__operating_system -> innmind__signals [color="#bb6188", label="^1.0"];
    ...
    league__uri -> league__uri_interfaces [color="#ef36b1", label="^2.0"];
    ...
    innmind__socket -> innmind__stream [color="#6b5f49", label="^1.5"];
    ...
    innmind__http_transport -> innmind__http [color="#d9c72a", label="~3.11"];
    ...
    innmind__http_transport -> innmind__time_warp [color="#d9c72a", label="^1.0"];
    innmind__http_transport -> innmind__time_continuum [color="#d9c72a", label="^1.3"];
    innmind__signals -> innmind__immutable [color="#67d973", label="^2.13"];
    ...
    innmind__cli [shape="ellipse", width="0.75", height="0.5", color="#87dfa2", URL="https://packagist.org/packages/innmind/cli#1.7.1"];
    innmind__stream [shape="ellipse", width="0.75", height="0.5", color="#5eb3ec", URL="https://packagist.org/packages/innmind/stream#1.5.0"];
    innmind__immutable [shape="ellipse", width="0.75", height="0.5", color="#a7e599", URL="https://packagist.org/packages/innmind/immutable#2.16.0"];
    innmind__url [shape="ellipse", width="0.75", height="0.5", color="#085cd3", URL="https://packagist.org/packages/innmind/url#2.0.3"];
    innmind__operating_system [shape="ellipse", width="0.75", height="0.5", color="#bb6188", URL="https://packagist.org/packages/innmind/operating-system#1.6.0"];
    ...
    innmind__filesystem [shape="ellipse", width="0.75", height="0.5", color="#a45b8d", URL="https://packagist.org/packages/innmind/filesystem#3.3.1"];
    symfony__dotenv [shape="ellipse", width="0.75", height="0.5", color="#681457", URL="https://packagist.org/packages/symfony/dotenv#v4.3.5"];
    ...
    league__uri [shape="ellipse", width="0.75", height="0.5", color="#ef36b1", URL="https://packagist.org/packages/league/uri#6.0.0"];
    ...
    league__uri_interfaces [shape="ellipse", width="0.75", height="0.5", color="#22ca7d", URL="https://packagist.org/packages/league/uri-interfaces#2.0.0"];
    ...
    innmind__server_control [shape="ellipse", width="0.75", height="0.5", color="#43d797", URL="https://packagist.org/packages/innmind/server-control#2.8.3"];
    innmind__socket [shape="ellipse", width="0.75", height="0.5", color="#6b5f49", URL="https://packagist.org/packages/innmind/socket#2.1.0"];
    innmind__http_transport [shape="ellipse", width="0.75", height="0.5", color="#d9c72a", URL="https://packagist.org/packages/innmind/http-transport#4.1.0"];
    innmind__signals [shape="ellipse", width="0.75", height="0.5", color="#67d973", URL="https://packagist.org/packages/innmind/signals#1.0.0"];
    symfony__process [shape="ellipse", width="0.75", height="0.5", color="#9cadc5", URL="https://packagist.org/packages/symfony/process#v4.3.5"];
    psr__log [shape="ellipse", width="0.75", height="0.5", color="#e9a8b6", URL="https://packagist.org/packages/psr/log#1.1.0"];
    symfony__filesystem [shape="ellipse", width="0.75", height="0.5", color="#1a4d29", URL="https://packagist.org/packages/symfony/filesystem#v4.3.5"];
    symfony__finder [shape="ellipse", width="0.75", height="0.5", color="#952a8a", URL="https://packagist.org/packages/symfony/finder#v4.3.5"];
    symfony__polyfill_ctype [shape="ellipse", width="0.75", height="0.5", color="#96e3a7", URL="https://packagist.org/packages/symfony/polyfill-ctype#v1.12.0"];
    ...
    innmind__http [shape="ellipse", width="0.75", height="0.5", color="#324178", URL="https://packagist.org/packages/innmind/http#3.11.1"];

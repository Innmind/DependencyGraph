...
digraph packages {
    ...
    innmind__immutable [label="immutable@5.20.0"];
    innmind__url [label="url@4.4.0"];
    }
    subgraph cluster_league {
        label="league"
        URL="https://packagist.org/packages/league/"
    league__uri_parser [label="uri-parser@1.4.1"];
    league__uri_interfaces [label="uri-interfaces@7.5.0"];
    league__uri [label="uri@7.5.1"];
    league__uri_components [label="uri-components@7.5.1"];
    }
    ...
    league__uri -> league__uri_interfaces [color="#ef36b1", label="^7.5"];
    league__uri_components -> league__uri [color="#de64b9", label="^7.5"];
    ...
    innmind__immutable [shape="ellipse", width="0.75", height="0.5", color="#a7e599", URL="https://packagist.org/packages/innmind/immutable#5.20.0"];
    ...
    league__uri_interfaces [shape="ellipse", width="0.75", height="0.5", color="#22ca7d", URL="https://packagist.org/packages/league/uri-interfaces#7.5.0"];
    league__uri [shape="ellipse", width="0.75", height="0.5", color="#ef36b1", URL="https://packagist.org/packages/league/uri#7.5.1"];
    league__uri_components [shape="ellipse", width="0.75", height="0.5", color="#de64b9", URL="https://packagist.org/packages/league/uri-components#7.5.1"];
    innmind__url [shape="ellipse", width="0.75", height="0.5", color="#085cd3", URL="https://packagist.org/packages/innmind/url#4.4.0"];
}
DOT;

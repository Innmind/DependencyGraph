...
digraph packages {
    ...
    guzzlehttp__guzzle -> guzzlehttp__ringphp [color="#e5a30c"];
    guzzlehttp__guzzle -> react__promise [color="#e5a30c"];
    ramsey__uuid -> paragonie__random_compat [color="#44619b"];
    ramsey__uuid -> symfony__polyfill_ctype [color="#44619b"];
    guzzlehttp__ringphp -> guzzlehttp__streams [color="#73c32a"];
    guzzlehttp__ringphp -> react__promise [color="#73c32a"];
    ...
    guzzlehttp__ringphp [shape="ellipse", width="0.75", height="0.5", color="#73c32a", URL="https://packagist.org/packages/guzzlehttp/ringphp"];
    react__promise [shape="ellipse", width="0.75", height="0.5", color="#a06550", URL="https://packagist.org/packages/react/promise"];
    guzzlehttp__streams [shape="ellipse", width="0.75", height="0.5", color="#f880a8", URL="https://packagist.org/packages/guzzlehttp/streams"];
    paragonie__random_compat [shape="ellipse", width="0.75", height="0.5", color="#ea17ff", URL="https://packagist.org/packages/paragonie/random_compat"];
